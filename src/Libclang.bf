...
static {
    ...
    public static c_int CINDEX_VERSION_MAJOR = 0;
    public static c_int CINDEX_VERSION_MINOR = 64;
     ...
     */
    [CLink]
    public static extern CXIndex clang_createIndex(c_int excludeDeclarationsFromPCH, c_int displayDiagnostics);
    /**
    ...
    public struct CXIndexOptions {
         ...
         */
        [Bitfield<c_uint>(.Public, .Bits(1), "ExcludeDeclarationsFromPCH")]
        /**
         * \see clang_createIndex()
         */
        [Bitfield<c_uint>(.Public, .Bits(1), "DisplayDiagnostics")]

            /**
             * Store PCH in memory. If zero, PCH are stored in temporary files.
             */
            [Bitfield<c_uint>(.Public, .Bits(1), "StorePreamblesInMemory")]
            [Bitfield<c_uint>(.Private, .Bits(13),"Buffer")]
			private uint16 _Field;
            /**
         ...
         */
        public c_uchar* InvocationEmissionPath;
    };
     ...
     * For example:
     * \code
     * CXIndex createIndex(c_char *ApplicationTemporaryPath) {
     *   constc_intExcludeDeclarationsFromPCH = 1;
     *   constc_intDisplayDiagnostics = 1;
     *   CXIndex Idx;
     ...
     */
    [CLink]
    public static extern CXIndex clang_createIndexWithOptions(CXIndexOptions * options);
     ...
     */
    [CLink]
    public static extern void clang_CXIndex_setGlobalOptions(CXIndex idx, c_uint options);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXIndex_getGlobalOptions(CXIndex idx);
     ...
     */
    [CLink]
    public static extern void clang_CXIndex_setInvocationEmissionPathOption(CXIndex idx, c_char * Path);
     ...
     */
    [CLink]
    public static extern c_uint clang_isFileMultipleIncludeGuarded(CXTranslationUnit tu, CXFile file);
     ...
     */
    [CLink]
    public static extern CXFile clang_getFile(CXTranslationUnit tu, c_char* file_name);
     ...
     */
    [CLink]
    public static extern c_char* clang_getFileContents(CXTranslationUnit tu, CXFile file, c_size* size);
     ...
     */
    [CLink]
    public static extern CXSourceLocation clang_getLocation(CXTranslationUnit tu, CXFile file, c_uint line, c_uint column);
    /**
     ...
     */
    [CLink]
    public static extern c_uint clang_getNumDiagnostics(CXTranslationUnit Unit);
     ...
     */
    [CLink]
    public static extern CXDiagnostic clang_getDiagnostic(CXTranslationUnit Unit, c_uint Index);
     ...
     */
    [CLink]
    public static extern CXTranslationUnit clang_createTranslationUnitFromSourceFile(CXIndex CIdx, c_char * source_filename, c_int num_clang_command_line_args, c_char * *clang_command_line_args, c_uint num_unsaved_files, CXUnsavedFile * unsaved_files);
     ...
     */
    [CLink]
    public static extern CXErrorCode clang_createTranslationUnit2(CXIndex CIdx, c_char * ast_filename, CXTranslationUnit * out_TU);
     ...
     */
    [CLink]
    public static extern CXTranslationUnit clang_parseTranslationUnit(CXIndex CIdx, c_char * source_filename, c_char * *command_line_args, c_int num_command_line_args, CXUnsavedFile * unsaved_files, c_uint num_unsaved_files, c_uint options);
     ...
     */
    [CLink]
    public static extern void clang_disposeTranslationUnit(CXTranslationUnit unit);
    ...
    [AllowDuplicates] enum CXCursorKind : int32 {
         ...
         * pointer constant that has integral type (e.g.,c_intor long) and is the same
         ...
         * struct count {
         *   static const c_uint value = sizeof...(Types);
         * };
         * \endcode
         */
     ...
     */
    [CLink]
    public static extern CXSourceRange clang_getCursorExtent(CXCursor c);
    ...
    /**
     * Retrieve the integer value of an enum constant declaration as an c_uint
     *  long long.
     *
     ...
     *  c_intWidth = clang_getFieldDeclBitWidth(Cursor);
     *   if (Width != -1) {
     ...
     *   template <typename T,c_intkInt, bool kBool>
     *   void foo() { ... }
     *
     *   template <>
    ...
    /**
     * Retrieve the value of an Integral TemplateArgument (of a function
     *  decl representing a template specialization) as an c_uint long long.
     *
     * It is undefined to call this function on a CXCursor that does not represent a
     ...
     */
    [CLink]
    public static extern c_int clang_getExceptionSpecificationType(CXType T);
     ...
     */
    [CLink]
    public static extern c_int clang_getNumArgTypes(CXType T);
     ...
     */
    [CLink]
    public static extern CXType clang_getArgType(CXType T, c_uint i);
     ...
     */
    [CLink]
    public static extern c_uint clang_Type_getNumObjCProtocolRefs(CXType T);
     ...
     */
    [CLink]
    public static extern CXCursor clang_Type_getObjCProtocolDecl(CXType T, c_uint i);
     ...
     */
    [CLink]
    public static extern c_uint clang_Type_getNumObjCTypeArgs(CXType T);
     ...
     */
    [CLink]
    public static extern CXType clang_Type_getObjCTypeArg(CXType T, c_uint i);

    /**
     * Return 1 if the CXType is a variadic function type, and 0 otherwise.
     */
    [CLink]
    public static extern c_uint clang_isFunctionTypeVariadic(CXType T);
     ...
     */
    [CLink]
    public static extern c_int clang_getCursorExceptionSpecificationType(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_isPODType(CXType T);
     ...
     */
    [CLink]
    public static extern c_longlong clang_getNumElements(CXType T);
     ...
     */
    [CLink]
    public static extern c_longlong clang_getArraySize(CXType T);
     ...
     */
    [CLink]
    public static extern c_longlong clang_Type_getAlignOf(CXType T);
     ...
     */
    [CLink]
    public static extern c_longlong clang_Type_getSizeOf(CXType T);
     ...
     */
    [CLink]
    public static extern c_longlong clang_Type_getOffsetOf(CXType T, c_char * S);
     ...
     */
    [CLink]
    public static extern c_longlong clang_Cursor_getOffsetOfField(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_isAnonymous(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_isAnonymousRecordDecl(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_int clang_Type_getNumTemplateArguments(CXType T);
     ...
     */
    [CLink]
    public static extern CXType clang_Type_getTemplateArgumentAsType(CXType T, c_uint i);
     ...
     */
    [CLink]
    public static extern c_uint clang_isVirtualBase(CXCursor c);
     ...
     */
    [CLink]
    public static extern CX_CXXAccessSpecifier clang_getCXXAccessSpecifier(CXCursor c);
     ...
     */
    [CLink]
    public static extern CX_StorageClass clang_Cursor_getStorageClass(CXCursor c);
     ...
     */
    [CLink]
    public static extern c_uint clang_getNumOverloadedDecls(CXCursor cursor);
     ...
     */
    [CLink]
    public static extern CXCursor clang_getOverloadedDecl(CXCursor cursor, c_uint index);
     ...
     */
    [CLink]
    public static extern CXType clang_getIBOutletCollectionType(CXCursor c);
     ...
     */
    [CLink]
    public static extern c_uint clang_visitChildren(CXCursor parent, function CXChildVisitResult(CXCursor cursor, CXCursor parent, CXClientData client_data) visitor, CXClientData client_data);
    /**
     * Visitor invoked for each cursor found by a traversal.
     *
     ...
     */
    [CLink]
    public static extern c_uint clang_visitChildrenWithBlock(CXCursor parent, function CXChildVisitResult(CXCursor cursor, CXCursor parent, CXClientData client_data)* block);
     ...
     */
    [CLink]
    public static extern CXString clang_getCursorUSR(CXCursor c);

    /**
     * Construct a USR for a specified Objective-C class.
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCClass(c_char * class_name);

    /**
     * Construct a USR for a specified Objective-C category.
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCCategory(c_char * class_name, c_char * category_name);

    /**
     * Construct a USR for a specified Objective-C protocol.
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCProtocol(c_char * protocol_name);
     ...
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCIvar(c_char * name, CXString classUSR);
     ...
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCMethod(c_char * name, c_uint isInstanceMethod, CXString classUSR);
     ...
     */
    [CLink]
    public static extern CXString clang_constructUSR_ObjCProperty(c_char * property, CXString classUSR);

    /**
     * Retrieve a name for the entity referenced by this cursor.
     */
    [CLink]
    public static extern CXString clang_getCursorSpelling(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXSourceRange clang_Cursor_getSpellingNameRange(CXCursor c, c_uint pieceIndex, c_uint options);
     ...
     */
    [CLink]
    public static extern c_uint clang_PrintingPolicy_getProperty(CXPrintingPolicy Policy, CXPrintingPolicyProperty Property);

    /**
     * Set a property value for the given printing policy.
     */
    [CLink]
    public static extern void clang_PrintingPolicy_setProperty(CXPrintingPolicy Policy, CXPrintingPolicyProperty Property, c_uint Value);
     ...
     */
    [CLink]
    public static extern CXPrintingPolicy clang_getCursorPrintingPolicy(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXString clang_getCursorDisplayName(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXCursor clang_getCursorReferenced(CXCursor c);
     ...
     *  \code
     * c_intf(int, int);
     * c_intg(int x,c_inty) { return f(x, y); }
     * c_intf(int a,c_intb) { return a + b; }
     * c_intf(int, int);
     *  \endcode
     *
     ...
     */
    [CLink]
    public static extern CXCursor clang_getCursorDefinition(CXCursor c);
     ...
     */
    [CLink]
    public static extern c_uint clang_isCursorDefinition(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXCursor clang_getCanonicalCursor(CXCursor c);
     ...
     */
    [CLink]
    public static extern c_int clang_Cursor_getObjCSelectorIndex(CXCursor c);
     ...
     */
    [CLink]
    public static extern c_int clang_Cursor_isDynamicCall(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_getObjCPropertyAttributes(CXCursor C, c_uint reserved);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_getObjCDeclQualifiers(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_isObjCOptional(CXCursor C);

    /**
     * Returns non-zero if the given cursor is a variadic function or method.
     */
    [CLink]
    public static extern c_uint clang_Cursor_isVariadic(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_Cursor_isExternalSymbol(CXCursor C, CXString * language, CXString * definedIn, c_uint * isGenerated);
     ...
     */
    [CLink]
    public static extern CXString clang_Cursor_getMangling(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXStringSet* clang_Cursor_getCXXManglings(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXStringSet* clang_Cursor_getObjCManglings(CXCursor c);
     ...
     */
    [CLink]
    public static extern CXModule clang_getModuleForFile(CXTranslationUnit t, CXFile f);
     ...
     */
    [CLink]
    public static extern c_int clang_Module_isSystem(CXModule Module);
     ...
     */
    [CLink]
    public static extern c_uint clang_Module_getNumTopLevelHeaders(CXTranslationUnit u, CXModule Module);
     ...
     */
    [CLink]
    public static extern CXFile clang_Module_getTopLevelHeader(CXTranslationUnit u, CXModule Module, c_uint Index);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXConstructor_isConvertingConstructor(CXCursor C);

    /**
     * Determine if a C++ constructor is a copy constructor.
     */
    [CLink]
    public static extern c_uint clang_CXXConstructor_isCopyConstructor(CXCursor C);

    /**
     * Determine if a C++ constructor is the default constructor.
     */
    [CLink]
    public static extern c_uint clang_CXXConstructor_isDefaultConstructor(CXCursor C);

    /**
     * Determine if a C++ constructor is a move constructor.
     */
    [CLink]
    public static extern c_uint clang_CXXConstructor_isMoveConstructor(CXCursor C);

    /**
     * Determine if a C++ field is declared 'mutable'.
     */
    [CLink]
    public static extern c_uint clang_CXXField_isMutable(CXCursor C);

    /**
     * Determine if a C++ method is declared '= default'.
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isDefaulted(CXCursor C);

    /**
     * Determine if a C++ method is declared '= delete'.
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isDeleted(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isPureVirtual(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isStatic(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isVirtual(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isCopyAssignmentOperator(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isMoveAssignmentOperator(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isExplicit(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXRecord_isAbstract(CXCursor C);

    /**
     * Determine if an enum declaration refers to a scoped enum.
     */
    [CLink]
    public static extern c_uint clang_EnumDecl_isScoped(CXCursor C);
     ...
     */
    [CLink]
    public static extern c_uint clang_CXXMethod_isConst(CXCursor C);
     ...
     */
    [CLink]
    public static extern CXTokenKind clang_getTokenKind(CXToken t);
     ...
     */
    [CLink]
    public static extern CXString clang_getTokenSpelling(CXTranslationUnit u, CXToken t);

    /**
     * Retrieve the source location of the given token.
     */
    [CLink]
    public static extern CXSourceLocation clang_getTokenLocation(CXTranslationUnit c, CXToken t);

    /**
     * Retrieve a source range that covers the given token.
     */
    [CLink]
    public static extern CXSourceRange clang_getTokenExtent(CXTranslationUnit c, CXToken t);
     ...
     */
    [CLink]
    public static extern void clang_tokenize(CXTranslationUnit TU, CXSourceRange Range, CXToken * *Tokens, c_uint * NumTokens);
     ...
     */
    [CLink]
    public static extern void clang_annotateTokens(CXTranslationUnit TU, CXToken * Tokens, c_uint NumTokens, CXCursor * Cursors);

    /**
     * Free the given set of tokens.
     */
    [CLink]
    public static extern void clang_disposeTokens(CXTranslationUnit TU, CXToken * Tokens, c_uint NumTokens);
    ...
    [CLink]
    public static extern void clang_getDefinitionSpellingAndExtent(CXCursor c, c_char * *startBuf, c_char * *endBuf, c_uint * startLine, c_uint * startColumn, c_uint * endLine, c_uint * endColumn);
    [CLink]
    public static extern void clang_enableStackTraces();
    [CLink]
    public static extern void clang_executeOnThread(function void(void*) fn, void* user_data, c_uint stack_size);
     ...
     */
    [CLink]
    public static extern CXCompletionChunkKind clang_getCompletionChunkKind(CXCompletionString completion_string, c_uint chunk_number);
     ...
     */
    [CLink]
    public static extern CXString clang_getCompletionChunkText(CXCompletionString completion_string, c_uint chunk_number);
     ...
     */
    [CLink]
    public static extern CXCompletionString clang_getCompletionChunkCompletionString(CXCompletionString completion_string, c_uint chunk_number);

    /**
     * Retrieve the number of chunks in the given code-completion string.
     */
    [CLink]
    public static extern c_uint clang_getNumCompletionChunks(CXCompletionString completion_string);
     ...
     */
    [CLink]
    public static extern c_uint clang_getCompletionPriority(CXCompletionString completion_string);
     ...
     */
    [CLink]
    public static extern c_uint clang_getCompletionNumAnnotations(CXCompletionString completion_string);
     ...
     */
    [CLink]
    public static extern CXString clang_getCompletionAnnotation(CXCompletionString completion_string, c_uint annotation_number);
     ...
     */
    [CLink]
    public static extern c_uint clang_getCompletionNumFixIts(CXCodeCompleteResults * results, c_uint completion_index);
     ...
     */
    [CLink]
    public static extern CXString clang_getCompletionFixIt(CXCodeCompleteResults * results, c_uint completion_index, c_uint fixit_index, CXSourceRange * replacement_range);
     ...
     */
    [CLink]
    public static extern c_uint clang_defaultCodeCompleteOptions();
     ...
     */
    [CLink]
    public static extern CXCodeCompleteResults* clang_codeCompleteAt(CXTranslationUnit TU, c_char * complete_filename, c_uint complete_line, c_uint complete_column, CXUnsavedFile * unsaved_files, c_uint num_unsaved_files, c_uint options);
     ...
     */
    [CLink]
    public static extern void clang_sortCodeCompletionResults(CXCompletionResult * Results, c_uint NumResults);
     ...
     */
    [CLink]
    public static extern c_uint clang_codeCompleteGetNumDiagnostics(CXCodeCompleteResults * Results);
     ...
     */
    [CLink]
    public static extern CXDiagnostic clang_codeCompleteGetDiagnostic(CXCodeCompleteResults * Results, c_uint Index);
     ...
     */
    [CLink]
    public static extern c_ulonglong clang_codeCompleteGetContexts(CXCodeCompleteResults * Results);
     ...
     */
    [CLink]
    public static extern CXCursorKind clang_codeCompleteGetContainerKind(CXCodeCompleteResults * Results, c_uint * IsIncomplete);
     ...
     */
    [CLink]
    public static extern void clang_toggleCrashRecovery(c_uint isEnabled);
     ...
     */
    [CLink]
    public static extern c_int clang_EvalResult_getAsInt(CXEvalResult E);
     ...
     */
    [CLink]
    public static extern c_longlong clang_EvalResult_getAsLongLong(CXEvalResult E);

    /**
     * Returns a non-zero value if the kind isc_intand the evaluation
     * result resulted in an c_uint integer.
     */
    [CLink]
    public static extern c_uint clang_EvalResult_isc_uintInt(CXEvalResult E);

    /**
     * Returns the evaluation result as an c_uint integer if
     * the kind isc_intand clang_EvalResult_isc_uintInt is non-zero.
     */
    [CLink]
    public static extern c_ulonglong clang_EvalResult_getAsc_uint(CXEvalResult E);
     ...
     * kind is other thanc_intor float. User must not free this pointer,
     * instead call clang_EvalResult_dispose on the CXEvalResult returned
     * by clang_Cursor_Evaluate.
     */
    [CLink]
    public static extern c_char* clang_EvalResult_getAsStr(CXEvalResult E);
     ...
     */
    [CLink]
    public static extern CXRemapping clang_getRemappings(c_char * path);
     ...
     */
    [CLink]
    public static extern CXRemapping clang_getRemappingsFromFileList(c_char * *filePaths, c_uint numFiles);

    /**
     * Determine the number of remappings.
     */
    [CLink]
    public static extern c_uint clang_remap_getNumFiles(CXRemapping r);
     ...
     */
    [CLink]
    public static extern void clang_remap_getFilenames(CXRemapping r, c_uint index, CXString * original, CXString * transformed);

    /**
     * Dispose the remapping.
     */
    [CLink]
    public static extern void clang_remap_dispose(CXRemapping r);
    ...
    [CLink]
    public static extern CXResult clang_findReferencesInFileWithBlock(CXCursor c, CXFile f, CXCursorAndRangeVisitor* b);

    [CLink]
    public static extern CXResult clang_findIncludesInFileWithBlock(CXTranslationUnit c, CXFile f, CXCursorAndRangeVisitor* b);
    ...
    public struct IndexerCallbacks {
         ...
         */
        function c_int(CXClientData client_data, void* reserved) abortQuery;

        /**
         * Called at the end of indexing; passes the complete diagnostic set.
         */
        function void(CXClientData client_data, CXDiagnosticSet s, void* reserved) diagnostic;

        function CXIdxClientFile(CXClientData client_data, CXFile mainFile, void* reserved) enteredMainFile;

        /**
         * Called when a file gets \#included/\#imported.
         */
        function CXIdxClientFile(CXClientData client_data, CXIdxIncludedFileInfo* i) ppIncludedFile;
         ...
         * the AST file.
         */
        function CXIdxClientASTFile (CXClientData client_data, CXIdxImportedASTFileInfo* info) importedASTFile;

        /**
         * Called at the beginning of indexing a translation unit.
         */
        function CXIdxClientContainer(CXClientData client_data, void* reserved) startedTranslationUnit;

        function void(CXClientData client_data, CXIdxDeclInfo* info) indexDeclaration;

        /**
         * Called to index a reference of an entity.
         */
        function void(CXClientData client_data, CXIdxEntityRefInfo* info) indexEntityReference;
    };

    [CLink]
    public static extern c_int clang_index_isEntityObjCContainerKind(CXIdxEntityKind kind);
    [CLink]
    public static extern CXIdxObjCContainerDeclInfo* clang_index_getObjCContainerDeclInfo(CXIdxDeclInfo * info);

    [CLink]
    public static extern CXIdxObjCInterfaceDeclInfo* clang_index_getObjCInterfaceDeclInfo(CXIdxDeclInfo * info);

    [CLink]
    public static extern CXIdxObjCCategoryDeclInfo* clang_index_getObjCCategoryDeclInfo(CXIdxDeclInfo* info);

    [CLink]
    public static extern CXIdxObjCProtocolRefListInfo* clang_index_getObjCProtocolRefListInfo(CXIdxDeclInfo * info);

    [CLink]
    public static extern CXIdxObjCPropertyDeclInfo* clang_index_getObjCPropertyDeclInfo(CXIdxDeclInfo * info);

    [CLink]
    public static extern CXIdxIBOutletCollectionAttrInfo* clang_index_getIBOutletCollectionAttrInfo(CXIdxAttrInfo * info);

    [CLink]
    public static extern CXIdxCXXClassDeclInfo* clang_index_getCXXClassDeclInfo(CXIdxDeclInfo * info);
     ...
     */
    [CLink]
    public static extern CXIdxClientContainer clang_index_getClientContainer(CXIdxContainerInfo * info);
     ...
     */
    [CLink]
    public static extern void clang_index_setClientContainer(CXIdxContainerInfo * info, CXIdxClientContainer container);

    /**
     * For retrieving a custom CXIdxClientEntity attached to an entity.
     */
    [CLink]
    public static extern CXIdxClientEntity clang_index_getClientEntity(CXIdxEntityInfo * info);

    /**
     * For setting a custom CXIdxClientEntity attached to an entity.
     */
    [CLink]
    public static extern void clang_index_setClientEntity(CXIdxEntityInfo * info, CXIdxClientEntity entity);
     ...
     */
    [CLink]
    public static extern c_int clang_indexSourceFileFullArgv(CXIndexAction a, CXClientData client_data, IndexerCallbacks * index_callbacks, c_uint index_callbacks_size, c_uint index_options, c_char * source_filename, c_char * *command_line_args, c_int num_command_line_args, CXUnsavedFile * unsaved_files, c_uint num_unsaved_files, CXTranslationUnit * out_TU, c_uint TU_options);
     ...
     */
    [CLink]
    public static extern c_int clang_indexTranslationUnit(CXIndexAction a, CXClientData client_data, IndexerCallbacks * index_callbacks, c_uint index_callbacks_size, c_uint index_options, CXTranslationUnit unit);
     ...
     */
    [CLink]
    public static extern void clang_indexLoc_getFileLocation(CXIdxLoc loc, CXIdxClientFile * indexFile, CXFile * file, c_uint * line, c_uint * column, c_uint * offset);
     ...
     */
    [CLink]
    public static extern c_uint clang_Type_visitFields(CXType T, function CXVisitorResult(CXCursor C, CXClientData client_data) visitor, CXClientData client_data);
     ...
     */
    [CLink]
    public static extern CXString clang_getBinaryOperatorKindSpelling(CXBinaryOperatorKind kind);
     ...
     */
    [CLink]
    public static extern CXBinaryOperatorKind clang_getCursorBinaryOperatorKind(CXCursor cursor);
     ...
     */
    [CLink]
    public static extern CXString clang_getUnaryOperatorKindSpelling(CXUnaryOperatorKind kind);
     ...
     */
    [CLink]
    public static extern CXUnaryOperatorKind clang_getCursorUnaryOperatorKind(CXCursor cursor);
}
